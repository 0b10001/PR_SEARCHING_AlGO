...
/*Generates the edges of a tree given number of edges. 
The edges are generated in such a way that there is connectivity. 
Cycles are also added to make the graph a bit fun.
*/
...
/*
Edges are generated as  Numbers but for easy view they are converted to letters
*/
...
/*
The backend implementation of the depth first search
*/
...
/*
The backend implementation of the breadth first search
*/
...
/* Displays the either stack buttons or queue buttons depending on the algorithm chosen*/
function searchDFS() {
...
/* Generating the graphs was inspired by the following youtube video  https://youtu.be/HP1tOlxVYz4?si=rDdetIZh7Pg2g7bT 
  The generatingNewGraph generates the graphs using the nodes and the edges generated by the generate edge function.
  */
...
// Highlights nodes when pushed in either stack/queue
